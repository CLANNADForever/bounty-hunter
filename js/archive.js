...
function save(archive_num,time_num){
    ...
    localStorage.setItem('Hound_' + usr + '_' + archive_num + 'villager_05', villager_05);
    localStorage.setItem('Hound_' + usr + '_' + archive_num + 'init_dialog_at_naan_01', init_dialog_at_naan_01);
...
function reload(archive_num){
    ...
    init_dialog_at_naan_01 = Number(localStorage.getItem('Hound_' + usr + '_' + archive_num + 'init_dialog_at_naan_01'));
